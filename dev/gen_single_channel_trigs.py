...
def read_command_line():
    parser = OptionParser(
        ...
        usage       = "%prog --gps-start-time --gps-end-time --channel --ifo --model-info --outdir --seg-list",
    ...
    return channel, gps_start, gps_end, ifo, frames, model_list, outdir, segments, ndcuid_list
...
def generate_triggers(channel,gps_start,gps_end,ifo,frames,model_list,outdir,segments,ndcuid_list):
...
if __name__=="__main__":
    read_command_line()
    channel,gps_start,gps_end,ifo,frames,model_list,outdir,segments,ndcuid_list = read_command_line()
    for entry in segments:
        generate_triggers(channel,entry[0],entry[1],ifo,frames,model_list,outdir,segments,ndcuid_list)
